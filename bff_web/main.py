...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("persistent://nomonoliticas/default/legal", "test-subscription-2", "public/default/nomonoliticas", eventos=eventos))
    tasks.append(task1)
