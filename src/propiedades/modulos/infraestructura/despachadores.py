...
from propiedades.modulos.infraestructura.schema.v1.eventos import EventoReservaCreada, ReservaCreadaPayload
from propiedades.modulos.infraestructura.schema.v1.comandos import ComandoCrearReserva, ComandoCrearReservaPayload
